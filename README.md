...
ステージに要素を追加する場合、それぞれステージデータに割り振られている番号を各セルに記入することで追加出来ます。
（割り振り番号一覧はシート「ステージデータ」にまとめました）

<br>

また先程記載した通り、現時点では1-1に登場する敵・トラップのみしか追加していないため作成自由度は低めです。  
![zisaku](https://user-images.githubusercontent.com/53967490/80562344-6a96a480-8a22-11ea-8188-98776e8553cb.png)
